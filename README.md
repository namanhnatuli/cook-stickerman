...
└── [slug-ten-video]/                 # Ví dụ: projects/every-cheesecake-explained/
    ...
    ├── 03_script_draft.md            # Bản thảo kịch bản voiceover đầu tiên (Pacing math 140–150 WPM)
    ├── 04_audit_review.md            # Báo cáo audit (Stage 1) và bản Final Script đã duyệt (Stage 2)
    ├── 05_scene_assets.md            # Storyboard phân cảnh (Anchor vs B-roll), Mascot cue & License checklist
...
| **Bước 3** | **Viết Kịch Bản Voiceover Thô**<br>Khóa tốc độ 140–150 WPM, tự động co giãn word-budget theo số item, phân bổ Hero Items và chọn góc kể chuyện linh hoạt. | [`script.md`](/prompts/scripts/script.md) | `projects/[slug]/03_script_draft.md` |
...
| **Bước 5** | **Lập Storyboard & Gán Mascot**<br>Phân 25–35 Scene Clusters (Anchor vs Supporting), giới hạn Mascot 5–8 lần và lập bảng kiểm tra bản quyền (cần người xác nhận). | [`scene_assets.md`](/prompts/scripts/scene_assets.md) | `projects/[slug]/05_scene_assets.md` |
