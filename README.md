...
└── [slug-ten-video]/                 # Ví dụ: projects/every-cheesecake-explained/
    ...
    ├── 08a_packaging_reconciliation.md # Khóa tiêu đề chính thức, kiểm chứng lời hứa & thời lượng so với rough cut
    ├── 08b_thumbnail.md              # Prompt tạo Final Hero Thumbnail (dựa trên visual proof) và Asset Sheet
...
| **Bước 4** | **Viết Kịch Bản Voiceover (Knowledge-First)**<br>Phóng tác từ Dàn ý đã duyệt qua quy trình 2-Pass (Pass 1: Bản thảo trọn vẹn tri thức; Pass 2: Tính thời lượng & Kế hoạch nén tùy chọn). Gắn internal claim markers (`[C1]`, `[C2]`) và lập Production Claim Ledger. Khung 5-beat pedagogy. | [`script.md`](prompts/scripts/script.md) | `projects/[slug]/04_script_draft.md` |
| **Bước 5** | **Audit Kịch Bản & Rà Soát Sơ Bộ Chính Sách (Stage 1 & 2)**<br>• *Stage 1:* Audit 8 tiêu chí (Factual integrity, Knowledge Completeness, Preflight policy/visual check & đánh giá Kế hoạch nén tùy chọn).<br>• *Stage 2 (Self-contained):* Chỉ rewrite khi có input bảng claim và định hướng cắt gọn đã duyệt. | [`review.md`](prompts/scripts/review.md) | `projects/[slug]/05_audit_review.md` |
...
| **Bước 8A** | **Hòa Giải Đóng Gói & Khóa Tiêu Đề (Packaging Reconciliation)**<br>Đối soát tiêu đề với rough cut và Claim Ledger; chống clickbait vượt quá nội dung, bảo toàn epistemic status, và khóa cụm thời lượng (ví dụ "Explained in X Minutes") theo timecode dựng thực tế. | [`packaging_reconciliation.md`](prompts/scripts/packaging_reconciliation.md) | `projects/[slug]/08a_packaging_reconciliation.md` |
| **Bước 8B** | **Thiết Kế Final Thumbnail & Asset Sheet**<br>Tạo prompt Hero Thumbnail dựa trên tiêu đề và visual proof đã hòa giải từ Bước 8A (chọn style: Food Photography, 3D Cutaway, hoặc Flat Editorial Diagram) và Asset Reference Sheet cho editor. | [`thumbnail.md`](prompts/scripts/thumbnail.md) | `projects/[slug]/08b_thumbnail.md` |
| **Bước 9** | **Tạo Mô Tả Video & Thẻ Tag Biến Thể Sai Chính Tả (SEO)**<br>Mô tả 200–300 từ dựa trực tiếp trên **Final Approved Script**, tiêu đề đã hòa giải từ Bước 8A, danh sách chương theo timecode đã khóa, và thẻ tag tập trung vào các biến thể/từ dễ viết sai. Cấm bịa fact ngoài kịch bản. | [`seo_description.md`](prompts/scripts/seo_description.md) | `projects/[slug]/09_seo_metadata.md` |
| **Bước 10** | **Đánh Giá Rủi Ro Chính Sách Trọn Gói (Package-Level Policy Audit)**<br>Đánh giá toàn diện kịch bản, tiêu đề, thumbnail và mô tả theo hai cổng tách biệt (Chính sách nền tảng YouTube & Tính xác thực kênh, và Chuẩn mực Epistemic nội bộ). Xuất bảng khuyến nghị patch. | [`policy_audit.md`](prompts/scripts/policy_audit.md) | `projects/[slug]/10_policy_check.md` |
| **Bước 11** | **Áp Dụng Bản Vá & Đóng Băng Bản Gốc Chuẩn (Canonical Master Freeze)**<br>Duyệt danh sách patch từ Bước 10. Kiểm tra đối chiếu đảm bảo không làm méo mó kiến thức.<br>*(Lưu ý quay vòng: Nếu patch làm thay đổi voiceover, bắt buộc quay lại Bước 7 thu âm lại và khóa lại timeline trước khi freeze).*<br>Lưu trữ hồ sơ xuất bản chính thức: Final Script, Title, Description, Thumbnail, Chapters, Timecodes và quyết định Platform Disclosure. | [`canonical_master_freeze.md`](prompts/scripts/canonical_master_freeze.md) | `projects/[slug]/11_canonical_master_freeze.md` |
