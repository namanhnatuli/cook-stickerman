...
4. **Sensational Deception & Medical Misinformation:** Exaggerating food toxicity, claiming common ingredients are lethal poisons, or fabricating medical emergencies triggers scrutiny.
...
| Flagged Asset / Line | Context & Policy Concern | Evaluated Risk (Low / Med / High) | Recommended Targeted Patch (Preserving Factual Accuracy) |
|---|---|---|---|
| *Excerpt from script, title, or thumbnail* | *Why this specific framing or visual could trigger an algorithmic filter* | *Risk level* | *Clean, natural rewrite without weird euphemisms* |

#### **3. Human Review & Studio Action Items:**
- **YouTube Studio Altered-Content Toggle:** State whether the platform-level "Altered Content" disclosure must be enabled. (Required under official YouTube policy when realistic AI/altered media depicts real people saying/doing things they didn't do, realistic scenes of real places/events that didn't happen, or realistic generated footage/audio of events that appear authentic. Not required for 2D sticker animations like Cook Stickerman, color grading, or stylized non-realistic CGI).
